...
public class S2CLogContentsPacket extends InPacket {
    ...
    public static class Payload extends ByteBufPayload {
        ...
        public static final Id<ByteBufPayload> ID = getId("s2c_log_contents");
